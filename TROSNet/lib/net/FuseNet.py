...
def define_FuseNet(num_labels = 3, rgb_enc=True, depth_enc=True, rgb_dec=True, depth_dec=False, norm='batch', use_dropout=True, init_type='xavier', init_gain=0.02):
	net = None
...
class FusenetGenerator(nn.Module):
	def __init__(self, num_labels = 3, rgb_enc=True, depth_enc=True, rgb_dec=True, depth_dec=False):
