...
baseline 6,7   my
baseline_ca 4,5 my2
baseline_cmf 2,3 my3
"""

class Configuration:
    def __init__(self):
        self.ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname("__file__"), '..', '..'))
        self.EXP_NAME = 'trosnet'
        ...
        self.TRAIN_MULTI_SCALE_OUTPUT = [1/2,1/4,1/8]   # 数据处理时默认包含了 factor == 1
